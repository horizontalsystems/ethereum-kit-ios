...
public class RawTransaction: Codable {
...
extension RawTransaction {
    ...
    public convenience init(wei: String, to: String, gasPrice: Int, gasLimit: Int, nonce: Int, data: Data = Data()) {
        self.init(value: Wei(wei)!, to: to, gasPrice: gasPrice, gasLimit: gasLimit, nonce: nonce, data: data)
    }
